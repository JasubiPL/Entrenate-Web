  ...
  return (
    <PrincipalLayout title='Ejersicio, Nutrición y Salud'>
      <main className=' min-h-screen flex flex-col items-center px-2 gap-4 bg-gray-950 py-4 text-white'>
        ...
        lg:flex-nowrap'>
          <Link href='/blog' className="group rounded-xl lg:max-w-full min-h-[276px] p-6 flex flex-col items-center
          justify-center gap-4 text-center border-2 border-gray-900 hover:border-gray-100
          hover:shadow-lg hover:shadow-orange-500 transition-all active:scale-95
          dev-list-mobile-animation-up bg-[url('/image/backgrounds/blog-2.avif')] max-w-sm">
            <div className="flex gap-2 items-center">
              <GiNotebook className='text-6xl'/>
              <h2 className='text-2xl'>BLOG</h2>
            </div>
            <p className="text-sm font-light">
              Descubre los secretos de una vida saludable a través de nuestro blog de nutrición y entrenamiento. Desde consejos prácticos hasta recetas deliciosas y rutinas de ejercicios efectivas, estamos aquí para guiarte en cada paso hacia tus objetivos fitness
            </p>
          </Link>
