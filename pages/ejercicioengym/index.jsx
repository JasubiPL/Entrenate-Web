      ...
      <main className="min-h-screen flex items-center bg-gray-950 py-4 flex-col text-white">
        ...
        <section className="w-full max-w-5xl gap-6 p-4">
          <ul className="w-full flex flex-wrap justify-evenly gap-5">
            <li>
              <Link href='/ejercicioengym/abdomen' className="dev-list-mobile-animation-up group rounded-full bg-slate-900 aspect-square flex 
            ...
            <li>
              <Link href='/ejercicioengym/pecho' className="dev-list-mobile-animation-up group rounded-full bg-slate-900 aspect-square flex 
              flex-col items-center justify-center gap-2 w-36 border-2 border-slate-900 lg:hover:border-green-500 
              lg:hover:scale-110 transition-all lg:active:scale-95">
                <GiAbdominalArmor className="text-5xl group-hover:text-green-500"/>
            ...
            <li>
              <Link href='/ejercicioengym/espalda' className="dev-list-mobile-animation-up group rounded-full bg-slate-900 aspect-square flex 
              flex-col items-center justify-center gap-2 w-36 border-2 border-slate-900 lg:hover:border-green-500 
              lg:hover:scale-110 transition-all lg:active:scale-95">
                <GiAbdominalArmor className="text-5xl group-hover:text-green-500"/>
            ...
            <li>
              <Link href='/ejercicioengym/hombros' className="dev-list-mobile-animation-up group rounded-full bg-slate-900 aspect-square flex 
              flex-col items-center justify-center gap-2 w-36 border-2 border-slate-900 lg:hover:border-green-500 
              lg:hover:scale-110 transition-all lg:active:scale-95">
                <GiAbdominalArmor className="text-5xl group-hover:text-green-500"/>
            ...
            <li>
              <Link href='/ejercicioengym/brazo' className="dev-list-mobile-animation-up group rounded-full bg-slate-900 aspect-square flex 
              flex-col items-center justify-center gap-2 w-36 border-2 border-slate-900 lg:hover:border-green-500 
              lg:hover:scale-110 transition-all lg:active:scale-95">
                <GiAbdominalArmor className="text-5xl group-hover:text-green-500"/>
            ...
            <li>
              <Link href='/ejercicioengym/pierna' className="dev-list-mobile-animation-up group rounded-full bg-slate-900 aspect-square flex 
              flex-col items-center justify-center gap-2 w-36 border-2 border-slate-900 lg:hover:border-green-500 
