...
export default function BackExcercise({ img, name, muscles_involved, execution, caution, }){
  return(
...
export async function getStaticPaths(){
  const files = await readdir("./excercises/gym-excercises/shoulder", "utf-8")
...
export async function getStaticProps({ params }){
  ...
  const content = await readFile(`./excercises/gym-excercises/shoulder/${id}.json`, "utf-8")
